...
export const translations = {
  es: {
    ...
    helpCountersMenuText:
      "Usa «Partida» en la barra superior para elegir un juego y una distribución. Una plantilla crea de una vez los contadores más habituales. Desde el mismo panel también puedes reiniciar los valores o añadir un contador nuevo.",
    helpCountersEditTitle: "Editar un contador",
    helpCountersEditText:
      "Pulsa el botón de opciones de un contador para editar su nombre, valor inicial, color, tamaño e icono. El selector de iconos permite buscar y explorar categorías como superhéroes, fantasía o combate. Desde las opciones también puedes cambiar el tamaño rápidamente o eliminar el contador.",
  ...
  en: {
    ...
    helpCountersMenuText:
      "Use “Game” in the top bar to choose a game and layout. A template creates the most common counters in one step. The same panel also lets you reset values or add a new counter.",
    helpCountersEditTitle: "Editing a counter",
    helpCountersEditText:
      "Select a counter’s options button to edit its name, initial value, color, size, and icon. Browse or search icon categories such as superheroes, fantasy, and combat. You can also quickly resize or delete a counter from its options.",
    helpChoasisTitle: "Choasis",
    helpChoasisText:
  ...
  it: {
    ...
    helpCountersMenuText:
      "Usa «Partita» nella barra superiore per scegliere un gioco e una disposizione. Un modello crea in un solo passaggio i contatori più comuni. Dallo stesso pannello puoi azzerare i valori o aggiungere un nuovo contatore.",
    helpCountersEditTitle: "Modificare un contatore",
    helpCountersEditText:
      "Premi il pulsante delle opzioni di un contatore per modificarne nome, valore iniziale, colore, dimensione e icona. Puoi cercare le icone o esplorare categorie come supereroi, fantasy e combattimento. Dalle opzioni puoi anche ridimensionare o eliminare il contatore.",
    helpChoasisTitle: "Choasis",
    helpChoasisText:
